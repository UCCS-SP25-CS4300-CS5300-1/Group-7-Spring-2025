...
The app is deployed with docker-compose and nginx on DigitalOcean. The app is an
active interview service which uses the chatgpt API to create a dynamic 
interview chat for job-seekers.
""".strip()
